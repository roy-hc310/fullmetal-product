...
type ProductServiceInterface interface {
	...
	GetListProduct(ctx context.Context, data *dto_v1.GetListProductRequest) (res []*dto_v1.GetListProductResponse, pagination *dto_v1.PaginationResponse, traceID string, err error)
	UpdateProduct(ctx context.Context, id string, data map[string]interface{}) (res string, traceID string, err error)
}
